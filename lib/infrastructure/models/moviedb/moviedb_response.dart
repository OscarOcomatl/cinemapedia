...
MovieDbResponse movieDbResponseFromMap(String str) => MovieDbResponse.fromJson(json.decode(str));

String movieDbResponseToMap(MovieDbResponse data) => json.encode(data.toJson());
