      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        background: Stack(
          children: [
            ...
            const _CustomGradient(begin: Alignment.topCenter,end: Alignment.bottomCenter, stops: [0.85, 1.0],colors: [Colors.transparent,Colors.black87],),
